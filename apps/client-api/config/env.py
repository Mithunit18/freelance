...
class Settings:
    ...
    # Exotel Call Masking
    EXOTEL_SID: str = os.getenv("EXOTEL_SID", "arwinnetworks1")
    EXOTEL_API_KEY: str = os.getenv("EXOTEL_API_KEY", "49f6f11c4f3644f2cdbd0c1d4237aec5f39cd1054a184cf4")
    EXOTEL_API_TOKEN: str = os.getenv("EXOTEL_API_TOKEN", "8806579be3baac04fda973f27f5575f0d4c6119e11a7d1dd")
    EXOTEL_CALLER_ID: str = os.getenv("EXOTEL_CALLER_ID", "08047362972")
