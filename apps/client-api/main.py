...
# Import creator app components
from creator_app.routes.session_routes import router as session_router
...
app.include_router(session_router, prefix="/api/v1", tags=["Creator Chat"])
